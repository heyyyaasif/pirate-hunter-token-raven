...
#Database --⚠️ REQUIRED--
DB_URL = os.environ.get("DB_URL", "mongodb+srv://AnimeRavenBots:AnimeRavenBots@animeravenbots.huekk.mongodb.net/?retryWrites=true&w=majority&appName=piratehunterzororavenbot")
...
TOKEN_PIC = os.environ.get("TOKEN_PIC", "https://envs.sh/H2o.jpg")
...
START_PIC = os.environ.get("START_PIC", "https://envs.sh/H2o.jpg")
FORCE_PIC = os.environ.get("FORCE_PIC", "https://envs.sh/H2o.jpg")
